...
public class Primer1 {
	...
	public static void main(String[] args) {
		// Unos i prikaz clanova celobrojnog niza X od N elemenata (x)
		// plus demonstracija kreiranja niza inicijalizacijom (arr)
		// plus demonstracija kreiranja niza sa praznom inicijalizacijom	(xi)
		// plus prikaz vrednosto svih kreiranih nizova
		...
		// čitanje arr niza; arr.length => dužina arr niza 
		// (moglo je i za dužine preth nizova: x-length i xi.length umesto n)
		System.out.print("\nVrednosti: ");
