...
public class TestKompozicije {
	...
	public static void main(String[] args) {
		...
		ts.dodajObjekat(new Bure(700,1,2));
		ts.dodajObjekat(new Sanduk(950,1,1,2));
		ts.dodajObjekat(new Bure(850,1,2));
		ts.dodajObjekat(new Sanduk(550,1,2,2));
		
		//vagoni
		//vagon 1
		Vagon vagon1 = new Vagon(800, 2300);
		izbor = (int) Math.floor(Math.random()*4);
		vagon1.addTeret(ts.getObjekat(izbor));
		izbor = (int) Math.floor(Math.random()*4);
		vagon1.addTeret(ts.getObjekat(izbor)); 
		//vagon 2
		Vagon vagon2 = new Vagon(750, 2100);
		izbor = (int) Math.floor(Math.random()*4);
